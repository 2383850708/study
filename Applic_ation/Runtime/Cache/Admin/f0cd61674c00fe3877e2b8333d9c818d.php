...
<!-- 页面基本设置禁止随意更改 -->
<!-- 基础CSS类库可随意更改 -->
<link rel="stylesheet" type="text/css" href="/enterprise/Public/Login/css/less.css" />
<link rel="stylesheet" type="text/css" href="/enterprise/Public/Login/css/basic.css" />
<!--[if IE 8]>
<link rel="stylesheet" type="text/css" href="/enterprise/Public/Login/ie8.css" />
<![endif]-->
<!--[if gte IE 9]> 
<link rel="stylesheet" type="text/css" href="/enterprise/Public/Login/css/ie.css" />
<![endif]-->
<!-- 基础CSS类库可随意更改 -->
<!-- 基础js类库可随意更改 -->
...
<div class="wrapper" style="background-color: white;">
  ...
  <div style="height: 60px;background-color: white;">
	<div style=";margin-left: 160px;">
		<img src="/enterprise/Public/Login/images/log_1.jpg" />	
	</div>
    ...
    <div class="login-topBg">
      <div class="login-topBg1">
        ...
        <div class="login-topStyle" >
          <form action="<?php echo U('Login/login');?>" id="for" method='post'>
            ...
            <div class="login-topStyle3" id="loginStyle" style="margin-top: 75px;">
              ...
              <div class="ui-form-item loginUsername">
                <input type="username" name="username" value='<?php echo ((isset($username) && ($username !== ""))?($username):""); ?>' placeholder="用户名/手机号/密码">
              </div>
              <div class="ui-form-item loginPassword">
                <input type="password" name='password'  placeholder="请输入密码">
              </div>
              <div class="ui-form-item loginPassword" >
                <input type="password" name='verify' style="width:110px;"  placeholder="请输入验证码"><span><img src="/enterprise/admin.php/Login/verifyImg" id="verify"  onClick="this.src=this.src+'?'+Math.random()" style="height:34px" /></span>
              </div>
              <div class="login_reme">
                <?php if($type == 1): ?><input type="checkbox" value='1' checked="checked" name="check">
                <?php else: ?>
                  <input type="checkbox" value='1'  name="check"><?php endif; ?>
              ...
              <a class="btnStyle btn-register" onclick="tijiao()" href="javascript:void(0)"> 立即登录</a> 
              </div>
            </form>
        </div>
      </div>
      ...
      <div class="loginCenter-moudle">
        ...
        <div class="loginCenter-moudleRight" style="  width: 1067px;"> 
          ...
          <a class="loginCenter-mStyle loginCenter-moudle1" id="moudleRemove" style=" display:block;width: 340px;">
           <span class="moudle-img"><img src="/enterprise/Public/Login/images/login_bg_01.png"></span>
          ...
          <span class="moudle-img"><img src="/enterprise/Public/Login/images/login_bg_02.png"></span> 
           <span class="moudle-text">
            ...
            <!--第三个--> 
                 ...
                 <span class="moudle-img"><img src="/enterprise/Public/Login/images/login_bg_03.png"></span> 
                   <span class="moudle-text"> 
                 <span class="moudle-text"> <span class="moudle-text1" style="font-family:'微软雅黑'">独立化自主经营 </span>
  ...
  <div class="footer"> <span class="footerText">Copyright © 1995-2015 江苏东成电动工具有限公司  苏ICP备: 10227676号</span> </div>
</div>
</body>
